...
function ListTodo() {
  ...
  const classNameBtn =
    "rounded-md focus:text-color7 font-bold py-1 bg-color4 hover:bg-color2 hover:text-color6 active:bg-color1 focus:outline-none focus:border-color5 focus:ring-4 focus:ring-color5";
      ...
      {isLoading ? (
        <div className="absolute inset-0 w-full h-full z-10 backdrop-blur-sm">
          <div className="flex h-full justify-center items-center">
            <div className="w-32 h-32 bg-color1 rounded-lg flex flex-col gap-6 justify-center items-center">
              <svg
                aria-hidden="true"
                className="w-8 h-8 mr-2 animate-spin dark:text-color1 fill-color5"
                viewBox="0 0 100 101"
                fill="none"
